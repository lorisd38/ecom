...
export class PromotionService {
  ...
  queryWithFilter(tagsId: string): Observable<EntityArrayResponseType> {
    const options = createRequestOption(tagsId);
    return this.http.get<IPromotion[]>(`${this.resourceUrl}/?filter=${tagsId}`, { params: options, observe: 'response' });
  }
}
