...
class ProductCartResourceIT {
    ...
    public static ProductCart createEntity(EntityManager em) {
        ProductCart productCart = new ProductCart().quantity(DEFAULT_QUANTITY);
        return productCart;
    }
    ...
    public static ProductCart createUpdatedEntity(EntityManager em) {
        ProductCart productCart = new ProductCart().quantity(UPDATED_QUANTITY);
        return productCart;
    }
    ...
    void putNewProductCart() throws Exception {
        ...
        updatedProductCart.quantity(UPDATED_QUANTITY);
    ...
    void fullUpdateProductCartWithPatch() throws Exception {
        ...
        partialUpdatedProductCart.quantity(UPDATED_QUANTITY);
