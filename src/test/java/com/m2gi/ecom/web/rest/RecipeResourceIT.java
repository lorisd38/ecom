...
class RecipeResourceIT {
    ...
    public static Recipe createEntity(EntityManager em) {
        Recipe recipe = new Recipe().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).steps(DEFAULT_STEPS).imagePath(DEFAULT_IMAGE_PATH);
        return recipe;
    }
    ...
    public static Recipe createUpdatedEntity(EntityManager em) {
        Recipe recipe = new Recipe().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).steps(UPDATED_STEPS).imagePath(UPDATED_IMAGE_PATH);
        return recipe;
    }
    ...
    void putNewRecipe() throws Exception {
        ...
        updatedRecipe.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).steps(UPDATED_STEPS).imagePath(UPDATED_IMAGE_PATH);
    ...
    void fullUpdateRecipeWithPatch() throws Exception {
        ...
        partialUpdatedRecipe.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).steps(UPDATED_STEPS).imagePath(UPDATED_IMAGE_PATH);
