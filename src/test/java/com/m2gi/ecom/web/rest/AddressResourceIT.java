...
class AddressResourceIT {
    ...
    void createAddress() throws Exception {
        ...
        assertThat(testAddress.getAdditionalDetails()).isEqualTo(DEFAULT_ADDITIONAL_DETAILS);
    }
    ...
    void putNewAddress() throws Exception {
        ...
        assertThat(testAddress.getAdditionalDetails()).isEqualTo(UPDATED_ADDITIONAL_DETAILS);
    }
